import std/os, sdl2, cstr, vulkanim/vulkan
...
proc main =
  ...
  doAssert vulkanGetInstanceExtensions(window, addr extensionCount,
      extensionNames.impl) == True32
  ...
  var enabledExtensionNames = newCStringArray([
  ...
  doAssert vkCreateDevice(physicalDevice, addr deviceCreateInfo, nil,
      addr device) == vkSuccess
